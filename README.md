...
# OMEGA Labs Commune Subnet: The World's Largest Decentralized AGI Multimodal Dataset <!-- omit in toc -->
...
- [x] Launch OMEGA Labs subnet on Commune
...
5. (Optional) Configure `miner_config.json`. `query_augment` options are: `NoAugment`, `LocalLLMAugment`, `OpenAIAugment`
...
3. Install pm2 if you don't already have it: [pm2.io](https://pm2.io/docs/runtime/guide/installation/).
4. Next, install the `omega` package: `pip install -e .`
5. (Optional) Configure `validator_config.json`.
